...
def select_closely_related(sketch_path, genus, mash_screen, contig_name, threads, contig_output_dir, mash_threshold, download_contig_nums, contig_id):

    if sketch_path:
        if mash_screen:
            mash_file = mash.screen(contig_name, sketch_path, threads, contig_output_dir, mash_threshold, download_contig_nums, contig_id)
        else:
            mash_file = mash.dist(contig_name, sketch_path, threads, contig_output_dir, mash_threshold , download_contig_nums, contig_id)
...
def homologous_retrieval(contig_name, minimap_args, threads, db, contig_output_dir):
...
def polish_genome(mash_screen,assembly, model_path, sketch_path, genus, threads, output_dir, minimap_args, mash_threshold, download_contig_nums, debug): 
    ...
    for contig in SeqIO.parse(assembly, 'fasta'):
        ...
        db_path = select_closely_related(sketch_path, genus, mash_screen, contig_name, threads, contig_output_dir, mash_threshold, download_contig_nums, contig.id)        
